...
export default function LoginPage() {
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden p-4">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_50%,oklch(0.68_0.18_35/0.1),transparent_50%)]" />
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_80%,oklch(0.45_0.12_264/0.1),transparent_50%)]" />
